<%-- 
    Document   : show.jsp
    Created on : Mar 17, 2022, 3:13:31 PM
    Author     : vgkhiem
--%>
        ...
        <div class="container mt-3">
            ...
            <div class="card" style="width: 18rem;">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">Show another</li>
                    <li class="list-group-item">A third item</li>
                </ul>
                <div class="card-body">
                    <td><a href="edit?id=${emp.getId()}" class="card-link">Edit</a></td>
                    <td><a href="delete?id=${emp.getId()}" class="card-link" onclick="return confirm('Are u sure want to delete?')">Delete</a></td>
                </div>
            </div>
